...
- More Backgrounds and possibly more custimizable options like buttons and hover effects
- Remove or Revamp the Speedrun Timer (its so chalked)
  - If Remove, try and find a replacement
    - if replacement i mean just a new tool
...
`"264710"
					{
						...
						"autocloud"
						{
							"lastlaunch"		"1777780231"
							"lastexit"		"1778264745"
						}
						"BadgeData"		"020000000811"
						"LaunchOptions"		"-novr"
