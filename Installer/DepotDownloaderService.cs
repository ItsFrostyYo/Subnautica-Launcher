...
public static class DepotDownloaderService
{
        ...
        string installDir)
    {
        ...
        string args =
            $"-app {VersionInstallDefinition.AppId} -depot {VersionInstallDefinition.DepotId} -manifest {version.ManifestId} -username \"{username}\" -password \"{password}\" -dir \"{installDir}\" -max-servers 1 -max-downloads 20";
